...
def DecisionTree():
    ...
    if (h=='yes'):
        ...
        ranfLb1.delete("1.0", END)
        ranfLb1.insert(END,nba)
    else:
        t1.delete("1.0", END)
...
def randomforest():
    ...
    nba=(nba)*100
    print(nba)
    #aaprint(accuracy_score(y_test, y_pred,normalize=False))
    ...
    if (h=='yes'):
        ...
        ranfLb2.delete("1.0", END)
        ranfLb2.insert(END,nba)
    else:
        t2.delete("1.0", END)
...
def NaiveBayes():
    ...
    if (h=='yes'):
        ...
        ranfLb3.delete("1.0", END)
        ranfLb3.insert(END, nba)
    else:
        t3.delete("1.0", END)
...
def grap():
    results ={'Accuracy': [95.355,95.123,96.12]}
    index = ['Decision Tree','RandomForest','NB']
    results=pd.DataFrame(results,index=index)
    fig =results.plot(kind='bar',title='Comaprison of models',figsize =(6,6),ylim=[40,100]).get_figure()
...
ranfLb1 =Text(root, height=1, width=30, fg="white", bg="green")
ranfLb1.grid(row=15, column=3, pady=10, sticky=W)

ranfLb2 =Text(root, height=1, width=30, fg="white", bg="green")
ranfLb2.grid(row=17, column=3, pady=10, sticky=W)

ranfLb3 = Text(root, height=1, width=30, fg="white", bg="green")
ranfLb3.grid(row=19, column=3, padx=10)
